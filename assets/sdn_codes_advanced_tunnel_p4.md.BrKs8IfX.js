import{_ as i,c as a,a2 as n,o as p}from"./chunks/framework.BjrWEbRN.js";const y=JSON.parse('{"title":"advanced_tunnel.p4","titleTemplate":false,"description":"","frontmatter":{"navbar":false,"sidebar":false,"aside":false,"prev":false,"next":false,"footer":false,"titleTemplate":false,"pageClass":"code-page","title":"advanced_tunnel.p4"},"headers":[],"relativePath":"sdn/codes/advanced_tunnel_p4.md","filePath":"sdn/codes/advanced_tunnel_p4.md"}'),h={name:"sdn/codes/advanced_tunnel_p4.md"};function l(k,s,t,e,E,d){return p(),a("div",null,s[0]||(s[0]=[n(`<div class="language-p4 vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">p4</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/* -*- P4_16 -*- */</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) main;</span></span></code></pre></div>`,1)]))}const g=i(h,[["render",l]]);export{y as __pageData,g as default};
